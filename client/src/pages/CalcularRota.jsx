...
const CalcularRota = () => {
  ...
  return (
    <div className="calcular-rota-container">
      <div className="page-header">
        <div className="header-content">
          ...
          <div>
            <h1>Calcular Rota</h1>
            <p className="subtitle">Encontre as rotas de transporte disponíveis para o aluno</p>
          </div>
        </div>
      </div>
          ...
          <div className="results-section">
            <div className="results-header">
              ...
              <div className="search-params">
                ...
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style={{opacity: 0.3}}>
                ...
                {results.routes.map((route, index) => (
                  <div key={index} className="route-card">
                    <div className="route-header">
                      ...
                      <div className="route-badge">Rota Compatível</div>
                    </div>
